...
public interface ExternalUpbitService {
    ...
    void doGetUpbitCoinDayPrice(String count);

    void doGetUpbitCoinMinutePrice(String count);
    ...
    // UpbitCoinMinutePrice -> UpbitCoinMinutePriceDTO 변환
    default UpbitCoinMinutePriceDTO entityToDTO(UpbitCoinMinutePrice entity) {
        return UpbitCoinMinutePriceDTO.builder()
                .market(entity.getMarket())                     // 코인 마켓 (예: KRW-BTC)
                .candle_date_time_kst(entity.getCandle_date_time_kst()) // KST 시간의 캔들 데이터
                .candle_date_time_utc(entity.getCandle_date_time_utc()) // UTC 시간의 캔들 데이터
                .opening_price(entity.getOpening_price())       // 시가
                ...
                .candle_acc_trade_price(entity.getCandle_acc_trade_price())   // 누적 거래 금액
                .candle_acc_trade_volume(entity.getCandle_acc_trade_volume()) // 누적 거래량
                .unit(entity.getUnit())                         // 전일종가 대신 unit
                .build();
    }

    // UpbitCoinMinutePriceDTO -> UpbitCoinMinutePrice 변환
    default UpbitCoinMinutePrice DTOtoEntity(UpbitCoinMinutePriceDTO dto) {
        return UpbitCoinMinutePrice.builder()
                .market(dto.getMarket())
                .candle_date_time_kst(dto.getCandle_date_time_kst())
                .candle_date_time_utc(dto.getCandle_date_time_utc())
                ...
                .candle_acc_trade_price(dto.getCandle_acc_trade_price())
